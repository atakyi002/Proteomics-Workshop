...
The code used in this workshop was originally developed by Dr. Paul Stewart. 

I am grateful for his mentorship and for his permission to use these materials for instructional purposes.
...
```{r, warning=FALSE}
prot = read.delim("data/dia_lfq_protein_updated_headers_2025-07-15.txt", header = TRUE, sep = "\t", row.names = 1, stringsAsFactors = FALSE)
prot$KO_TP_5 = as.numeric(prot$KO_TP_5)
```
